</svg><h1><img src="https://emojis.slackmojis.com/emojis/images/1531849430/4246/blob-sunglasses.gif?1531849430" width="30"/> Hey, nice to see you.</h1>

<br>

Hi, I'm [Thanseefuddeen](https://thanseef.in/), an **AI Engineer / Data Scientist** at Orion Innovation 🇮🇳, where I lead a team of 12 and run weekly training sessions on Agentic AI, multi-agent systems, and MCP. My work spans LLM fine-tuning, RAG systems, and agentic frameworks across Azure and AWS. I also enjoy teaching data science, ML, AI, and IoT to enthusiasts.

<br>

<p align="center">
  <img src="./assets/terminal-card.svg" alt="Thanseefuddeen — terminal card" width="100%"/>
</p>
...
- Agentic AI & multi-agent systems (MCP)
...
- 🌏 See my portfolio [thanseef.in](https://thanseef.in/)
...
<g clip-path="url(#round)">
  ...
  <rect width="100%" height="40" fill="#12161d"/>
  <line x1="0" y1="40" x2="1360" y2="40" stroke="#000000" stroke-opacity="0.35" stroke-width="1"/>
  <circle cx="24" cy="20" r="6.5" fill="#ff5f57"/>
  <circle cx="46" cy="20" r="6.5" fill="#febc2e"/>
  <circle cx="68" cy="20" r="6.5" fill="#28c840"/>
  <text x="680" y="24" text-anchor="middle" fill="#8b949e" font-family="SFMono-Regular, Consolas, 'Liberation Mono', Menlo, monospace" font-size="13">thanseefpp@orion-innovation: ~</text>
</g>
